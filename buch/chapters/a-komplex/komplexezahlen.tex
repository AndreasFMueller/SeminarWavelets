...
\index{imaginare Einheit@imagin\äre Einheit}
...
\index{Realteil}%
\index{Imaginarteil@Imagin\ärteil}%
\index{komplexe Zahl!Realteil}%
\index{komplexe Zahl!Imagin\ärteil}%
...
\index{spezielle unit\äre Gruppe}
\index{SU(2)}
...
-[A,B].
\]
\index{Jacobi-Identit\ät!f\ür Operatoren}%
