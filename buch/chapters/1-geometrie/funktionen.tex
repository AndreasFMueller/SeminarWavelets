...
Für die Entwicklung der Wavelet-Theorie ist notwendig, dass Signale
...
zu bilden und orthonormierte Basen zu konstruieren, dieses Ziel wird
allerdings erst in Kapitel~\ref{chapter:fourier} erreicht werden.

\subsection{Vektorräume von Funktionen}
Sein $X$ eine Menge, dann ist
\[
...
Wenn $X$ eine Teilmenge von $\mathbb R^n$ ist, dann 
