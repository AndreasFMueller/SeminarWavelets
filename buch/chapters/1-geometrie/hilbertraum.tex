...
also auf dieses hermitesche Skalarprodukt nicht direkt übertragen.
...
Dazu müssen wir Differenzen $\| X_n-X_m\|$ untersuchen.
...
Hilbertraum $H$ heisst ein {\em Erzeugendensystem}, wenn es keinen Vektor
...
Die Parallelogrammregel besagt, dass die Summe der Quadrate über den
...
der Geraden $\{tx\;|\;t\in\mathbb C\}$ einen Punkt $\tilde{x}$ auf der
...
das folgende analoge Minimalproblem zu lösen (Siehe auch
...
Sind $x_1,x_2$ zwei verschiedene Approximationen des minimalen Abstands, d.~h.
\[
...
\index{Riesz!Darstellungssatz von}%
...
Ist $\varphi\colon H\to \mathbb C$ eine stetige Linearform auf $H$, dann 
