...
\fill[color=red!10]
	plot[domain=-2.2:4.2,samples={\steps}]
		({\x},{2*exp(-(\x-\b)*(\x-\b)*2))}) --
	plot[domain=4.2:-2.2,samples={\steps}]
...
\draw[->,line width=0.7pt] (-2.2,0)--(4.5,0) coordinate[label=$t$];
\draw[->,line width=0.7pt] (0,-2.2)--(0,2.3);
\draw[line width=1pt,color=red] plot[domain=-2.2:4.2,samples={\steps}]
...
\draw[->,line width=0.7pt] (-2.2,0)--(4.5,0) coordinate[label=$t$];
\draw[->,line width=0.7pt] (0,-2.2)--(0,2.3);
\draw[line width=1pt,color=blue] plot[domain={-2.2}:{4.2},samples={\steps}]
