...
%\node at (0.5,0) [above] {$\varphi$};
%\node at (1.5,0) [above] {$T_1\varphi$};
%\node at (2.5,0) [above] {$T_2\varphi$};
%\node at (3.5,0) [above] {$T_3\varphi$};

\node at (0.0,0.9) [above] {$\psi$};
\node at (1.0,0.9) [above] {$T_2\psi$};
\node at (2.5,0.9) [above] {$T_5\psi$};
