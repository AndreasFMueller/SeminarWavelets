...
%
\subsection{Der Intervall-Trick und der Periodisierungs-Operator}
...
Da $b\in\mathbb Z$, berechnet das Integral~\eqref{msa:intervalltrick}
...
\label{msa:skal}}
Das Vaterwavelet einer Multiskalen-Analyse muss einer Skalierungsrelation
...
In der Multiskalen-Analyse bilden die Translate des Mutterwavelet $\psi$
...
in Abschnitt~\ref{msa:skal} bereits für das Vaterwavelet $\varphi$ untersucht
...
\begin{satz}
Die Funktion $m_\psi$, die zum Mutterwavelet einer Multiskalen-Analyse 
gehört, erfüllt
\[
...
Ist $\varphi$ das Vaterwavelet einer Multiskalen-Analyse, dann sind die
...
vom Mutterwavelet einer Multiskalen-Analyse sprechen.
