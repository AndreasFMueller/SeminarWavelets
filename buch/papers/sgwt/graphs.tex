...
des Graphen in~\cref{fig:sgwt:graph:fungraph} mit farblich kodierten 
Funktionswerten.
...
\begin{figure}
    ...
    \vspace{-160pt}
    \caption{Graph Approximation einer Strecke. Speziell sind dabei 
    die Endknoten $1$ und $8$, die jeweils nur den Grad $1$ statt $2$ haben. 
