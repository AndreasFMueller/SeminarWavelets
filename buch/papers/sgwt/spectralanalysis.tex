...
\begin{figure}
    ...
    \vspace{-45pt}
    \caption{Eigenwerte $\lambda_0$ bis $\lambda_{999}$ eines ungewichteten 
    Kreisgraphen.
...
Eine weitere wichtige Rolle spielen die Eigenvektoren $\chi$ der 
Laplace-Matrix. Diese sind n\"amlich approximierte Eigenfunktionen des 
Laplace-Operators $\Delta$. So ist die komplexe Exponentialfunktion $e^{i\omega 
x}$ die Eigenfunktion des eindimensionalen Laplace-Operators 
$\frac{d^2}{dx^2}$~\cite{chung_spectral_nodate}.

Auch die Kugelfunktionen $Y^m_l$, lassen sich mit Hilfe der 
...
\subsubsection{Eigenvektoren: Kreisgraph}
Die Eigenfunktionen des Kreisgraphen, zu sehen 
...
Approximation der auch in der Fourier-Theorie verwendeten periodischen Sinus 
und Kosinus Funktionen.
\begin{figure}
    \centering
    \begin{minipage}[t]{0.49\textwidth}
        ...
        \vspace{-45pt}
        \caption{$\chi_0$ eines ungewichteten Kreisgraphen mit 1000 Knoten.}
    ...
    \begin{minipage}[t]{0.49\textwidth}
        ...
        \vspace{-45pt}
        \caption{$\chi_1$ eines ungewichteten Kreisgraphen mit 1000 Knoten.}
    ...
    \begin{minipage}[t]{0.49\textwidth}
        ...
        \vspace{-45pt}
        \caption{$\chi_2$ eines ungewichteten Kreisgraphen mit 1000 Knoten.}
    ...
    \begin{minipage}[t]{0.49\textwidth}
        ...
        \vspace{-45pt}
        \caption{$\chi_3$ eines ungewichteten Kreisgraphen mit 1000 Knoten.}
    ...
    \begin{minipage}[t]{0.49\textwidth}
        ...
        \vspace{-45pt}
        \caption{$\chi_4$ eines ungewichteten Kreisgraphen mit 1000 Knoten.}
    ...
    \begin{minipage}[t]{0.49\textwidth}
        ...
        \vspace{-45pt}
        \caption{$\chi_5$ eines ungewichteten Kreisgraphen mit 1000 Knoten.}
...
gravierende Auswirkungen, wenn wir die Eigenvektoren, zu sehen 
