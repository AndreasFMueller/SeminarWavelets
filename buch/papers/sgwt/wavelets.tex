...
welche die Eigenschaften $g(0) = 0$ und $\lim_{\lambda\to\infty} g(\lambda) = 
0$ 
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.49\textwidth}
        ...
        \vspace{-20pt}
        \caption{Darstellung eines Dirac-Stoss $\delta(x)$ mit maximal Wert 
        $1$. 
    ...
    \begin{minipage}[t]{0.49\textwidth}
        ...
        \caption{Anwendung der Kernelfunktion $g(\lambda)$ auf die Graph 
            Transformation des Dirac-Stosses $\hat{\delta(x)}$ 
            aus~\cref{fig:sgwt:gft:dirac},
            $\hat{\delta}_g(\lambda) = g(\lambda)\cdot\hat{\delta}(\lambda)$.
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.49\textwidth}
        ...
        \caption{Fourier Transformation des Dirac-Stosses $\hat{\delta(x)}$ 
            aus~\cref{fig:sgwt:gft:dirac}.\label{fig:sgwt:gft:igt1gft}}
    \end{minipage}
    ~
    \begin{minipage}[t]{0.49\textwidth}
        \includegraphics[
        ...
        \vspace{-0pt}
        \caption{Fourier Transformation des Dirac-Stosses $\hat{\delta(x)}$ 
            aus~\cref{fig:sgwt:gft:dirac}.\label{fig:sgwt:gft:gt2gft}}
    \end{minipage}
    ~
    \begin{minipage}[t]{0.49\textwidth}
        \includegraphics[
        ...
        \vspace{-0pt}
        \caption{Fourier Transformation des Dirac-Stosses $\hat{\delta(x)}$ 
            aus~\cref{fig:sgwt:gft:dirac}.\label{fig:sgwt:gft:igt2gft}}
    \end{minipage}
    ~
    \begin{minipage}[t]{0.49\textwidth}
        \includegraphics[
        ...
        \vspace{-0pt}
        \caption{Fourier Transformation des Dirac-Stosses $\hat{\delta(x)}$ 
            aus~\cref{fig:sgwt:gft:dirac}.\label{fig:sgwt:gft:gt3gft}}
    \end{minipage}
    ~
    \begin{minipage}[t]{0.49\textwidth}
        \includegraphics[
        ...
        \vspace{-0pt}
        \caption{Fourier Transformation des Dirac-Stosses $\hat{\delta(x)}$ 
            aus~\cref{fig:sgwt:gft:dirac}.\label{fig:sgwt:gft:igt3gft}}
    \end{minipage}
\end{figure}
...
\begin{figure}
    ...
    \vspace{-0pt}
    \caption{Fourier Transformation des Dirac-Stosses $\hat{\delta(x)}$ 
    aus~\cref{fig:sgwt:gft:dirac}.\label{fig:sgwt:gft:igt4gft}}
    \end{minipage}
    ~
    \begin{minipage}[t]{0.49\textwidth}
    \includegraphics[
    ...
    \vspace{-0pt}
    \caption{Fourier Transformation des Dirac-Stosses $\hat{\delta(x)}$ 
    aus~\cref{fig:sgwt:gft:dirac}.\label{fig:sgwt:gft:gt5gft}}
    \end{minipage}
    ~
    \begin{minipage}[t]{0.49\textwidth}
    \includegraphics[
    ...
    \vspace{-0pt}
    \caption{Fourier Transformation des Dirac-Stosses $\hat{\delta(x)}$ 
    aus~\cref{fig:sgwt:gft:dirac}.\label{fig:sgwt:gft:igt5gft}}
    \end{minipage}
    ~
    \begin{minipage}[t]{0.49\textwidth}
    \includegraphics[
    ...
    \vspace{-0pt}
    \caption{Fourier Transformation des Dirac-Stosses $\hat{\delta(x)}$ 
    aus~\cref{fig:sgwt:gft:dirac}.\label{fig:sgwt:gft:hgft}}
    \end{minipage}
    ~
    \begin{minipage}[t]{0.49\textwidth}
    \includegraphics[
    ...
    \vspace{-0pt}
    \caption{Fourier Transformation des Dirac-Stosses $\hat{\delta(x)}$ 
    aus~\cref{fig:sgwt:gft:dirac}.\label{fig:sgwt:gft:ihgft}}
    \end{minipage}
\end{figure}
