...
\begin{figure}
    ...
    \begin{minipage}[t]{0.49\textwidth}
        ...
        \caption{Anwendung der Kernelfunktion $g(\lambda)$ auf die Graph 
            ...
            aus~\cref{fig:sgwt:gft:dirac},
            $\hat{\delta}_g(\lambda) = g(\lambda)\cdot\hat{\delta}(v)$.
...
Wenn wir nun zus\"atzlich die Eigenwerte mit 
einem Skalierungsfaktor $t$ multiplizieren, erhalten wir auch eine 
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.49\textwidth}
        ...
        \vspace{-0pt}
        \caption{Spektrum eines Ringgraphen 
