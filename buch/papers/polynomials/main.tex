...
\begin{figure}
    \centering
    \input{papers/polynomials/images/polynomials_sin_signals.pgf}
...
\begin{figure}
    \centering
    \input{papers/polynomials/images/polynomials_sin_db2.pgf}
...
\begin{figure}
    \centering
    \input{papers/polynomials/images/polynomials_sin_fft.pgf}
...
\begin{figure}
    \centering
    \input{papers/polynomials/images/polynomials_sin_padded_db2.pgf}
