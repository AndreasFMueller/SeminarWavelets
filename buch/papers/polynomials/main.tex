...
Wir werden im folgenden Daubechies Wavelets mit $A$ verschwindender Momente mit
db$A$ bezeichnen.
...
In~\autoref{polynomials:haar} sind die Approximations und die Detail Koeffizienten
...
In \autoref{polynomials:diff} sind zum Vergleich die Differenzierungen der
