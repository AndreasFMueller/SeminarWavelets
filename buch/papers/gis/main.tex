...
$k$ kann die Werte $0.5$ oder $1$ annehmen.
...
Es sind die Wavelet-Transformationen von den Beiden Wavelets welche Oben zitiert sind.
...
Bei der Auswertung wurden Wavelets aus den folgenden Familien verwendet.
\begin{itemize}
	\item Haar
	\item Daubechies 
	\item Symlets
...
Die Zeitsignale von den Zweien gehörten jeweils zu einer der Beiden Fehlerarten Oberflächenentladung oder Hohlraumentladung.
