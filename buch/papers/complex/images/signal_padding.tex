...
\begin{document}
	\begin{tikzpicture}
	\begin{scope}
	\begin{axis}[axis lines=middle, width=12cm, height=3cm, title={Original},
	...
	\begin{axis}[axis lines=middle, width=12cm, height=3cm, title={Zero-Padded},
	xmin=-200, xmax=200, ymin=-1.2, ymax=1.3, ytick={-2}, xtick={-2000}]
	...
	\begin{axis}[axis lines=middle, width=12cm, height=3cm, title={Gespiegelt},
	xmin=-200, xmax=200, ymin=-1.2, ymax=1.3, ytick={-2}, xtick={-2000}]
	...
	\end{axis}
	\end{scope}
	\begin{scope}[yshift=-7.5 cm]
	\begin{axis}[axis lines=middle, width=12cm, height=3cm, title={Gespiegelt, Konjugiert-Komplex},
	xmin=-200, xmax=200, ymin=-1.2, ymax=1.3, ytick={-2}, xtick={-2000}]
