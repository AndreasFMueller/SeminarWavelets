...
Sie spannen zusammen einen unendlichdimensionalen, reellen Hilbertraum auf. % TODO quasi einen unendlich^2-Raum...?
\begin{align*}
...
\begin{align*}
	...
	(u(t),\, v(t)) &\mapsto u(t) + iv(t) % Auch nur so, weil sin / cos 90° zueinander. R x R 'grösser' C
\end{align*}
