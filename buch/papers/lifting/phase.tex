...
geraden und die ungeraden Samples eine leicht unterschiedlich
behandelt.
...
Wir wenden den eukldischen Algorithmus auf die beiden Polyonem $h_e(z)$
und $h_o(z)$ an.
...
Hardware mit nur einer Multiplikation und einer durchführen lässt.
