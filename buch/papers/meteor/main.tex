...
\rhead{Detektieren von Meteoren}
...
\rhead{Auswertung der Radio-Signale}
...
\index{BRAMS}%
\index{Belgian Radio Meteor Stations}%
...
Die Audiofiles im \text{.wav} Format können wie folgt eingelesen werden:
\lstinputlisting[language=Matlab,style=Matlab]{papers/meteor/listings/bandpass.m}
%\begin{lstlisting}
...
\lstinputlisting[language=Matlab,style=Matlab]{papers/meteor/listings/bandpass2.m}
%\begin{lstlisting}
%frrange     = [1050 1150];
...
\lstinputlisting[language=Matlab,style=Matlab]{papers/meteor/listings/sig.m}
%\begin{lstlisting}
%sig(sig<0.025) = 0;
%\end{lstlisting}
...
\lstinputlisting[language=Matlab,style=Matlab]{papers/meteor/listings/gfft.m}
%\begin{lstlisting}
%figure('Name','GFFT');
%SNR = 100;
%wind = 2^14;
...
\lstinputlisting[language=Matlab,style=Matlab]{papers/meteor/listings/morlet.m}
%\begin{lstlisting}
%wav = 'amor';
%cfs = cwt(sig,wav,Fs);
%\end{lstlisting}
...
\lstinputlisting[language=Matlab,style=Matlab]{papers/meteor/listings/mod.m}
%\begin{lstlisting}
%tmp1 = abs(cfs);
%t1 = size(tmp1,2);
%tmp1 = tmp1';
...
\lstinputlisting[language=Matlab,style=Matlab]{papers/meteor/listings/scalogram.m}
%\begin{lstlisting}
