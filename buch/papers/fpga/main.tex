...
Then, a implementation of this algorithm in VHDL is presented.
...
This can be accomplished with the MATLAB function \texttt{idivide(x, 'floor')} instead of using the normal division operator (\texttt{/}).
The special rounding leads to divisions which are numerically identical to integer divisions in hardware.
