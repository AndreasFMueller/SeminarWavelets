...
Deeper in the multiresolution analysis, the coefficients change slower.
...
We Found an efficient algorithm (lifting scheme) for a hardware implementation of the DWT.
