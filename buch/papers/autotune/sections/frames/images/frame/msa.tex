...
\foreach \x in {36,37,...,52}
\draw[ultra thick, red] (\x,2)--(\x,-1);

\foreach \x in {36,38,...,52}
\draw[ultra thick, red] (\x,-1)--(\x,-4);

\foreach \x in {36,40,...,52}
...
\foreach \x in {18.1,19.1,...,34.1}{
	\draw[ultra thick, red] (\x,-13.9)--(\x,-16.9);
}
\foreach \x in {18.1,20.1,...,34.1}{
	\draw[ultra thick, red] (\x,-16.9)--(\x,-19.9);
}

\foreach \x in {18.1,22.1,...,34.1}{
...
\foreach \x in {18.05,19.05,...,34.05}{
	\draw[ultra thick, blue] (\x,-14.95)--(\x,-17.95);
}
\foreach \x in {18.05,20.05,...,34.05}{
	\draw[ultra thick, blue] (\x,-17.95)--(\x,-20.95);
}

\foreach \x in {18.05,22.05,...,34.05}{
