...
\begin{figure}[h]
	\centering
	\lstinputlisting[language=Python,firstline = 1, lastline = 45, numbers=left,style = mystyle]{papers/wwt/code/plot_burglind.py}
	\caption{Python Codeausschnitt}
	\label{fig:python-plot-code}
\end{figure}
\begin{figure}[h]
	\centering
	\lstinputlisting[language=Python,firstline = 46, lastline = 91, numbers=left,style = mystyle]{papers/wwt/code/plot_burglind.py}
	\caption{Python Codeausschnitt}
