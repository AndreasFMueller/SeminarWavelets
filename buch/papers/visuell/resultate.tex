...
\begin{figure}
	\centering
	\subfigure{\includegraphics[width=0.3\linewidth]{./papers/visuell/images/kernel1-scaled}}
	\subfigure{\includegraphics[width=0.3\linewidth]{./papers/visuell/images/kernel2-scaled}}
	\subfigure{\includegraphics[width=0.3\linewidth]{./papers/visuell/images/kernel3-scaled}}
...
\begin{figure}
	\centering
	\subfigure{\includegraphics[width=0.3\linewidth]{./papers/visuell/images/kernelG1-scaled}}
	\subfigure{\includegraphics[width=0.3\linewidth]{./papers/visuell/images/kernelG2-scaled}}
	\subfigure{\includegraphics[width=0.3\linewidth]{./papers/visuell/images/kernelG3-scaled}}
