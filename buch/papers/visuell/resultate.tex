...
Die Kernel welche gelernt wurden sehen zufällig aus, es sind keine Regelmässigkeiten zu erkennen (vgl. Abbildung \ref{fig:cnnkernels}). %TODO
...
Es gibt genügend Beispiele wo CNNs solche Kernels gelernt haben (z.B. im Paper \cite{paper:kernel}). %TODO
