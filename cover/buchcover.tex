...
\node at (20.4,8.9) [scale=0.53]{\includegraphics{gis2.jpg}};
\end{scope}
...
% Buchrückseite
\node at ({\einschlag+0.5*\breite},20.2) [color=white] {\sf
...
Ausgehend vom Skalarprodukt in der Vektorgeometrie wurde als Grundlage
die Hilbertraum-Theorie studiert und darauf aufbauend zunächst das
einfache Haar-Wavelet vorgeführt.
Daraus ergab sich dann die stetige Wavelettransformation und die
Zulässigkeitsbedingung für Wavelets.
Anschliessend wurden der Begriff der Multiskalenanalyse erarbeitet
und die für technische Anwendungen besser geeignete Wavelets mit
mit kompaktem Träger und der zugehörige schnelle Wavelet\-algorithmus
entwickelt.
